...
class CalibrationTestORM(CalibrationORM):
    __tablename__ = "test_calibrations"

    id: Mapped[uuid.UUID] = mapped_column(String(36), primary_key=True)
    filename: Mapped[str] = mapped_column(String, nullable=False)
    master_cal: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    cal_type: Mapped[str] = mapped_column(String, nullable=False)
    instrument_era: Mapped[str] = mapped_column(String, nullable=False)
